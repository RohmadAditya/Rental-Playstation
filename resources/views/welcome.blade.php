...
<body id="page-top">
    ...
    <!-- Games-->
    <section class="page-section" id="games">
        <div class="container">
            <div class="text-center">
